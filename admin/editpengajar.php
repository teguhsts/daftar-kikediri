...
<html lang="en">
  <head>
    ...
    <title>Calon Pendaftaran Relawan Pengajar | Kelas Inspirasi Kediri #4</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div style="margin-left:20px;margin-right:20px;" class="row">
  	 ...
  	 <div class="row">
  	  <div class="form-group col-md-10 col-md-offset-1">
           <label for="Briefing">Apakah Anda bersedia mengikuti briefing relawan pengajar?*</label><?php if($tampil['briefing']=="Ya"){$ya="selected";}else{$tidak="selected";}?>
           <select class="form-control" id="Briefing" name="Briefing" required>
             <option value="">-- pilih --</option>
    	     <option value="Ya" <?php echo $ya;?>>Ya, saya bersedia mengikuti briefing relawan pengajar.</option>
  	 ...
  	 <div class="row">
  	  <div class="form-group col-md-10 col-md-offset-1">
           ...
           <input type="text" name="TempatKerjaLama" class="form-control" id="TempatKerjaLama" value="<?php echo $tampil['tempatkerjalalu'];?>">
          </div>
  	 </div>
  	 <div class="row">
  	  <div class="form-group col-md-10 col-md-offset-1">
           <label for="PosisiKerjaLama">Jabatan/Posisi Sebelumnya</label>
           <input type="text" name="PosisiKerjaLama" class="form-control" id="PosisiKerjaLama" value="<?php echo $tampil['posisikerjalalu'];?>">
          </div>
  	 </div>
  	 <div class="row">
  	  <div class="form-group col-md-10 col-md-offset-1">
  	   <label for="LamaBekerjaLama">Lama Bekerja di Perusahaan Sebelumnya</label><?php if ($tampil['lamakerjalalu']=="Di bawah 2 tahun"){$lkl1="selected";}else if($tampil['lamakerjalalu']=="2 tahun"){$lkl2="selected";}else if($tampil['lamakerjalalu']=="3 tahun"){$lkl3="selected";}else if($tampil['lamakerjalalu']=="4 tahun"){$lkl4="selected";}else if($tampil['lamakerjalalu']=="5 tahun"){$lkl5="selected";}else if($tampil['lamakerjalalu']=="6 tahun"){$lkl6="selected";}else if($tampil['lamakerjalalu']=="7 tahun"){$lkl7="selected";}else if($tampil['lamakerjalalu']=="8 tahun"){$lkl8="selected";}else if($tampil['lamakerjalalu']=="Di atas 20 tahun"){$lkl9="selected";}else{$lkl10="selected";}?>
  	   <select class="form-control" id="LamaBekerjaLama" name="LamaBekerjaLama">
  	     <option value="" <?php echo $lkl10;?>>-- pilih --</option>
  	     <option value="Di bawah 2 tahun" <?php echo $lkl1;?>>Di Bawah 2 Tahun</option>
	      <option value="2 tahun" <?php echo $lkl2;?>>2 Tahun</option>
<option value="3 tahun" <?php echo $lkl3;?>>3 Tahun</option>
<option value="4 tahun" <?php echo $lkl4;?>>4 Tahun</option>
<option value="5 tahun" <?php echo $lkl5;?>>5 Tahun</option>
<option value="6 tahun" <?php echo $lkl6;?>>6 Tahun</option>
<option value="7 tahun" <?php echo $lkl7;?>>7 - 10 Tahun</option>
<option value="8 tahun" <?php echo $lkl8;?>>11 - 20 Tahun</option>
<option value="Di atas 20 tahun"<?php echo $lkl9;?>>Di atas 20 Tahun</option>
  	   </select>
  	  </div>
  	 </div>
  	 <div class="row">
  	  <div class="form-group col-md-10 col-md-offset-1">
  	   <label for="LamaBekerjaTotal">Lama Bekerja Total (di Luar Masa Kuliah)</label><?php if ($tampil['totallamakerja']=="Di bawah 2 tahun"){$lkt1="selected";}else if($tampil['totallamakerja']=="2 tahun"){$lkt2="selected";}else if($tampil['totallamakerja']=="3 tahun"){$lkt3="selected";}else if($tampil['totallamakerja']=="4 tahun"){$lkt4="selected";}else if($tampil['totallamakerja']=="5 tahun"){$lkt5="selected";}else if($tampil['totallamakerja']=="6 tahun"){$lkt6="selected";}else if($tampil['totallamakerja']=="7 tahun"){$lkt7="selected";}else if($tampil['totallamakerja']=="8 tahun"){$lkt8="selected";}else if($tampil['lamakerjalalu']=="Di atas 20 tahun"){$lkl9="selected";}else{$lkl10="selected";}?>
  	   <select class="form-control" id="LamaBekerjaTotal" name="LamaBekerjaTotal">
  	     <option value="" <?php echo $lkl10;?>>-- pilih --</option>
  	     <option value="Di bawah 2 tahun" <?php echo $lkt1;?>>Di Bawah 2 Tahun</option>
<option value="2 tahun" <?php echo $lkt2;?>>2 Tahun</option>
<option value="3 tahun" <?php echo $lkt3;?>>3 Tahun</option>
<option value="4 tahun" <?php echo $lkt4;?>>4 Tahun</option>
<option value="5 tahun" <?php echo $lkt5;?>>5 Tahun</option>
<option value="6 tahun" <?php echo $lkt6;?>>6 Tahun</option>
<option value="7 tahun" <?php echo $lkt7;?>>7 - 10 Tahun</option>
<option value="8 tahun" <?php echo $lkt8;?>>11 - 20 Tahun</option>
<option value="Di atas 20 tahun"<?php echo $lkt9;?>>Di atas 20 Tahun</option>
  	   </select>
  	  </div>
  	 </div>
  	 <div class="row">
  	  ...
  	  <div class="form-group col-md-10 col-md-offset-1">
           ...
           <input type="text" name="NamaOrganisasi" class="form-control" id="NamaOrganisasi" value="<?php echo $pecahorg['0'];?>">
          </div>
  	 </div>
  	 <div class="row">
  	  <div class="form-group col-md-10 col-md-offset-1">
           <label for="JabatanOrganisasi">Jabatan Dalam Organisasi</label>
           <input type="text" name="JabatanOrganisasi" class="form-control" id="JabatanOrganisasi" value="<?php echo $pecahorg['1'];?>">
          </div>
  	 </div>
  	 <div class="row">
  	  <div class="form-group col-md-10 col-md-offset-1">
  	    <label for="AktivitasOrganisasi">Aktivitas Organisasi</label>
  	    <textarea class="form-control" rows="4" id="AktivitasOrganisasi" name="AktivitasOrganisasi" required><?php echo $pecahorg['2'];?></textarea> 
  	  </div> 
  	 </div>
  	 <div class="row">
  	  <div class="form-group col-md-10 col-md-offset-1">
           <label for="NamaOrganisasiLain">Nama Organisasi yang Lain</label>
           <input type="text" name="NamaOrganisasiLain" class="form-control" id="NamaOrganisasiLain" value="<?php echo $pecahorgl['0'];?>">
          </div>
  	 </div>
  	 <div class="row">
  	  <div class="form-group col-md-10 col-md-offset-1">
           <label for="JabatanOrganisasiLain">Jabatan Dalam Organisasi yang Lain</label>
           <input type="text" name="JabatanOrganisasiLain" class="form-control" id="JabatanOrganisasiLain" value="<?php echo $pecahorgl['1'];?>">
          </div>
  	 </div>
  	 <div class="row">
          <div class="form-group col-md-10 col-md-offset-1" style="color:#DD4814;">
  	  ...
  	  <div class="form-group col-md-10 col-md-offset-1">
  	    ...
  	    <textarea class="form-control" rows="4" id="Prestasi" name="Prestasi" ><?php echo $tampil['prestasi'];?></textarea> 
  	  </div> 
  	 </div>
  	 <div class="row">
          <div class="form-group col-md-10 col-md-offset-1" style="color:#DD4814;">
  	  ...
  	  <div class="form-group col-md-10 col-md-offset-1">
  	    ...
  	    <textarea class="form-control" rows="4" id="Motivasi" name="Motivasi" required><?php echo $tampil['motivasi'];?></textarea> 
  	  </div> 
  	 </div>
  	 <div class="row">
  	  <div class="form-group col-md-10 col-md-offset-1">
  	    <label for="Peran">Apa Peran Profesi dan Kegiatan Anda Terhadap Kehidupan Bermasyarakat?*</label>
  	    <textarea class="form-control" rows="4" id="Peran" name="Peran"  required><?php echo $tampil['peranprofesi'];?></textarea> 
  	  </div> 
  	 </div>
  	 <div class="row">
  	  <div class="form-group col-md-10 col-md-offset-1">
  	    <label for="Cerita">Ceritakanlah Kejadian Paling Mengesankan Semasa Anda Menjalani Pendidikan*</label>
  	    <textarea class="form-control" rows="4" id="Cerita" name="Cerita" required><?php echo $tampil['pengalamanunik'];?></textarea> 
  	  </div> 
  	 </div>
  	 <div class="row">
  	 <div class="form-group col-md-6 col-md-offset-3">
  	 <a type="cancel" style="margin-top:10px;padding-left:20px;padding-right:20px;" class="btn btn-default" href="tampil.php">Batal</a>
  	 ...
  	 <a type="cancel" onclick="return konfirmasi()" style="margin-left:20px;margin-top:10px;padding-left:20px;padding-right:20px;" class="btn btn-danger" href="hapuspengajar.php?email=<?php echo $tampil['email'];?>">Hapus</a>
  	 </div>
  	 </div>
	</form>
      </div>
