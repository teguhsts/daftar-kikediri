...
$waktu=$tampil['waktu'];
//delete database
$sqldel="DELETE FROM `daftarki_fasil`.`dokumenter` WHERE `dokumenter`.`email` = '$email'";
...
$peralatan=$tampil['peralatan'];
$portofolio=$tampil['portofolio'];

//memasukkan data ke database
$sql = "INSERT INTO  `daftarki_fasil`.`dokumenter` (`kesediaan`,`briefing`,`ikut`,`pernahikut`,`mengapaikutlagi`,`nama`,`jeniskelamin`,`pendidikan`,`fb`,`twitter`,`email`,`ttl`,`domisili`,`hp`,`tempatkerja`,`profesikerja`,`bidangkerja`,`lamakerja`,`deskripsikerja`,`peralatan`,`portofolio`,`waktu`,`status`)VALUES ('$kesediaan','$briefing','$ikut','$pernahikut','$mengapaikutlagi','$nama','$jeniskelamin','$pendidikan','$fb','$twitter','$email','$ttl','$domisili','$hp','$tempatkerja','$profesikerja','$bidangkerja','$lamakerja','$deskripsikerja','$peralatan','$portofolio','$waktu','$status')";
...
mysql_close($koneksi);
header("Location: http://daftar.kelasinspirasikediri.org/admin/tampil.php?relawan=dokumentasi");
?>