...
$pesan = "Gagal memasukkan data. Kemungkinan alamat email sudah digunakan.<p><p>Gunakan email yang lain atau minta admin untuk menghapus entry sebelumnya.</p>";
}else if ($em=="3"){
...
echo "<p>Terjadi kesalahan. ".$pesan."<p>Hubungi CP untuk bantuan lebih lanjut. CP 085655833059 (Jayanti)</p>";
?>
</div>
