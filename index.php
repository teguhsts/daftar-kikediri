  ...
  <body>
    ...
    <div class="container">
      ...
      <div style="margin-bottom:20px;color:#DD4814;" class="row text-center">
        <h3>Portal Pendaftaran Relawan</h3>
        <p>KI Kediri #4</p>
      </div>
      
      <div style="margin-bottom:20px;" class="row text-center">
        <img src="../../images/oprec.png" class="img-responsive center-block" width="450px" height="300px">
      
      <a type="cancel" style="margin-top:30px;padding-left:20px;padding-right:20px;" class="btn btn-warning" href="pengajar">Relawan Pengajar</a>
      <a type="cancel" style="margin-left:20px;margin-top:30px;padding-left:10px;padding-right:10px;" class="btn btn-success" href="dokumentasi">Relawan Dokumentasi</a>
